...
namespace ProjectTracking.Migrations
{
    ...
    [Migration("20201003181137_new role data")]
            ...
            modelBuilder.Entity("ProjectTracking.ApplicationIdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e572", ConcurrencyStamp = "f35cd48b-dd7e-4851-92e0-abb9ecf4d869", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e590", ConcurrencyStamp = "dc248962-55e5-454d-b322-9b0f4b09ae5b", Name = "User", NormalizedName = "USER" }
                    );
                });
            ...
            modelBuilder.Entity("ProjectTracking.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575", AccessFailedCount = 0, ConcurrencyStamp = "0fd75d23-f03f-48da-860a-d69313ff7c07", DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "admin@sys.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "ADMIN@SYS.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEFN5CFUtPoLfkXv054JIcaxokZi/0YBJ3/5iVYRpHVS14OcwH0ysUvJ5G0cJ1gTB0A==", PhoneNumberConfirmed = false, RoleId = "a18be9c0-aa65-4af8-bd17-00bd9344e572", SecurityStamp = "", TwoFactorEnabled = false, UserName = "admin" },
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e576", AccessFailedCount = 0, ConcurrencyStamp = "8b581366-d0fb-449e-8dfb-847b191e0b01", DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "alikleitcr7@gmail.com", EmailConfirmed = true, LockoutEnabled = false, NormalizedEmail = "ALIKLEITCR7@GMAIL.COM", NormalizedUserName = "ALIKLEIT", PasswordHash = "AQAAAAEAACcQAAAAEFqbO6uqs/300sedhGKD5ZOrRvVTcYQC7xxEfgF+YgGoNIkBAF+yFt9uEwsg6yLKCw==", PhoneNumberConfirmed = false, RoleId = "a18be9c0-aa65-4af8-bd17-00bd9344e590", SecurityStamp = "", TwoFactorEnabled = false, UserName = "alikleit" }
                    );
                });
