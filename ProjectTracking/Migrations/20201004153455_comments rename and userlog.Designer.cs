...
namespace ProjectTracking.Migrations
{
    ...
    [Migration("20201004153455_comments rename and userlog")]
    partial class commentsrenameanduserlog
    {
            ...
            modelBuilder.Entity("ProjectTracking.ApplicationIdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e572", ConcurrencyStamp = "d1c2c2f0-18c5-4911-9939-c55321802e8d", Name = "Admin", NormalizedName = "ADMIN" },
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e590", ConcurrencyStamp = "05fb03eb-11e1-4af4-b870-3d4081516964", Name = "User", NormalizedName = "USER" }
                    );
                });
            ...
            modelBuilder.Entity("ProjectTracking.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e575", AccessFailedCount = 0, ConcurrencyStamp = "ec39bba9-d916-4ee4-88a2-74e5e47fb63d", DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "admin@sys.com", EmailConfirmed = true, FirstName = "Admin", LockoutEnabled = false, NormalizedEmail = "ADMIN@SYS.COM", NormalizedUserName = "ADMIN", PasswordHash = "AQAAAAEAACcQAAAAEOnxoq8/rq3HmpmYmH0+lIZlhgYMkIP3Zxyc+A6IaPctTsFL+86cG6i17JSz0dOhwA==", PhoneNumberConfirmed = false, SecurityStamp = "", Title = "Admin", TwoFactorEnabled = false, UserName = "admin" },
                        new { Id = "a18be9c0-aa65-4af8-bd17-00bd9344e576", AccessFailedCount = 0, ConcurrencyStamp = "01802a18-3dec-4296-9c7f-e77e076afbd8", DateOfBirth = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Email = "alikleitcr7@gmail.com", EmailConfirmed = true, FirstName = "Ali", LastName = "Kleit", LockoutEnabled = false, NormalizedEmail = "ALIKLEITCR7@GMAIL.COM", NormalizedUserName = "ALIKLEIT", PasswordHash = "AQAAAAEAACcQAAAAEKxv/Ohv7Agm8iJEq/jtMJ14FuXrH6ASrehsc+/BfNWDT9KxSL2kt8w0tIcGwN8xVA==", PhoneNumberConfirmed = false, SecurityStamp = "", Title = "Developer", TwoFactorEnabled = false, UserName = "alikleit" }
                    );
                });
