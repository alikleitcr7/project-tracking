    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Supervisers", x => new { x.UserId, x.SupervisorId });
                    table.ForeignKey(
                        name: "FK_Supervisers_AspNetUsers_SupervisorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comments = table.Column<string>(nullable: true),
                    TimeSheetId = table.Column<int>(nullable: false),
                    SuperviserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeSheetStatuses", x => x.ID);
                    table.ForeignKey(
                        name: "FK_TimeSheetStatuses_AspNetUsers_SuperviserId",
                        column: x => x.SuperviserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeSheetStatuses_TimeSheets_TimeSheetId",
                        column: x => x.TimeSheetId,
                        principalTable: "TimeSheets",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IpAddress = table.Column<string>(nullable: true),
                    TimeSheetProjectId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSheetActivities_MeasurementUnit_MeasurementUnitId",
                        column: x => x.MeasurementUnitId,
                        principalTable: "MeasurementUnit",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeSheetActivities_ProjectReference_ProjectFileId",
                        column: x => x.ProjectFileId,
                        principalTable: "ProjectReference",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeSheetActivities_TimeSheetProjects_TimeSheetProjectId",
                        column: x => x.TimeSheetProjectId,
                        principalTable: "TimeSheetProjects",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeSheetActivities_TypeOfWork_TypeOfWorkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeSheetActivityLogs_MeasurementUnit_MeasurementUnitId",
                        column: x => x.MeasurementUnitId,
                        principalTable: "MeasurementUnit",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TimeSheetActivityLogs_ProjectReference_ProjectFileId",
                        column: x => x.ProjectFileId,
                        principalTable: "ProjectReference",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TimeSheetActivityLogs_TypeOfWork_TypeOfWorkId",
                        column: x => x.TypeOfWorkId,
                        principalTable: "TypeOfWork",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "a18be9c0-aa65-4af8-bd17-00bd9344e572", "99869ee7-da61-4e81-9f9a-a242a5a071f2", "IdentityRole", "Admin", null });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "a18be9c0-aa65-4af8-bd17-00bd9344e575", 0, null, "c9e0b10b-b788-409a-ba44-0521adeeade4", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@sys.com", true, null, null, null, null, null, false, null, null, null, "admin@sys.com", "admin", "AQAAAAEAACcQAAAAENwUSxzSqTKHEEuO1Ts4RjOjcLlk3oHo5c2sYZipovl8UCsH8e3p4QVmkwGRWv01Sw==", null, false, "", null, false, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Supervisers_SupervisorId",
                table: "Supervisers",
                column: "SupervisorId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivities_MeasurementUnitId",
                table: "TimeSheetActivities",
                column: "MeasurementUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivities_ProjectFileId",
                table: "TimeSheetActivities",
                column: "ProjectFileId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivities_TimeSheetProjectId",
                table: "TimeSheetActivities",
                column: "TimeSheetProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivities_TypeOfWorkId",
                table: "TimeSheetActivities",
                column: "TypeOfWorkId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivityLogs_MeasurementUnitId",
                table: "TimeSheetActivityLogs",
                column: "MeasurementUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivityLogs_ProjectFileId",
                table: "TimeSheetActivityLogs",
                column: "ProjectFileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetActivityLogs_TypeOfWorkId",
                table: "TimeSheetActivityLogs",
                column: "TypeOfWorkId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetStatuses_SuperviserId",
                table: "TimeSheetStatuses",
                column: "SuperviserId");

            migrationBuilder.CreateIndex(
                name: "IX_TimeSheetStatuses_TimeSheetId",
                table: "TimeSheetStatuses",
                column: "TimeSheetId");
